export const TEXT_ONLY = [
  ...
  {
    id: 5302,
    content: 'I dropped my laptop and the screen is not cracked, can you fix it?',
    account_id: 2,
    inbox_id: 486,
    conversation_id: 1016,
    message_type: 0,
    ...
    external_source_ids: {},
    additional_attributes: {},
    processed_message_content: 'I dropped my laptop and the screen is not cracked, can you fix it?',
    sentiment: {},
    conversation: {
      assignee_id: 1,
      unread_count: 1,
  ...
  },
  {
    ...
    status: 'read',
    content_type: 'text',
    processed_message_content: 'Sure, will it be possible to share an image of the same?',
    id: 5304,
  ...
  },
  {
    ...
    status: 'read',
    content_type: 'text',
    processed_message_content: 'This is a video demo of how to safely pack your device for mail',
    id: 5318,
    content: 'This is a video demo of how to safely pack your device for mail',
    account_id: 2,
    inbox_id: 486,
    message_type: 1,
  ...
  },
  {
    ...
    status: 'read',
    content_type: 'text',
    processed_message_content: 'Glad I could help. Let me know if you need some other help',
    id: 5323,
  ...
  },
  {
    ...
    id: 5328,
    content: "Let us know if you have any questions, I'll close this conversation for now",
    account_id: 1,
    inbox_id: 475,
    message_type: 1,
    ...
    source_id: null,
    content_attributes: {
      external_error: 'Business account is restricted from messaging users in this country.',
    },
    sender_type: 'User',
    sender_id: 1,
    external_source_ids: {},
